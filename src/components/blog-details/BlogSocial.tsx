  ...
  return (
    <div className="blog__meta-3 d-sm-flex justify-content-between align-items-center mb-80">
      <div className="blog__tag-2">
        <Link href="/blog" style={{ pointerEvents: 'none', cursor: 'default' }}>IB Curriculum</Link>
        <Link href="/blog" style={{ pointerEvents: 'none', cursor: 'default' }}>Extended Essay</Link>
        <Link href="/blog" style={{ pointerEvents: 'none', cursor: 'default' }}>Theory of Knowledge</Link>
      </div>
