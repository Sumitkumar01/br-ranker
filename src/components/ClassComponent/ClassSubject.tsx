...
const ClassSubject = ({ board, category, categoryClass }: any) => {
...
//   };
  ...
  useEffect(() => {
    ...
    const filteredCourses = updatedCourses.filter(course => course.board === board && course.category === category && course.categoryClass === categoryClass)
    return (
                                ...
                                >
                                    <div className="row">
                                        ...
                                        {filteredCourses.length != 0 ?
                                                        ...
                                                        <div className="course__item white-bg mb-30 fix " >
                                                                ...
                                                                <div className="course__meta d-flex align-items-center justify-content-between">
                                                                    <div className="course__lesson">
                                                                        <span>
                                                                            ...
                                                                            {selectedPackage?selectedPackage.lecture:"20 Class per month"} Lesson
                                                                        </span>
                                                                    </div>
                                                            ...
                                                            <div className="course__more d-flex justify-content-between align-items-center">
                                                                <div className="course__status">
                                                                    ...
                                                                    >
                                                                         {selectedPackage?.price === undefined ? "₹2000" : (selectedPackage.price === 0 ? "Free" : `${currencySymbol}${selectedPackage.price}.00`)}
                                                                    </span>
                                                                    {/* <span className="old-price">
                                                                    {selectedPackage?.oldPrice === undefined?"₹2200":(selectedPackage?.oldPrice === 0 ? "Free" :`₹${selectedPackage.oldPrice}`)}
                                                                    </span> */}
                                                                </div>
                                            ...
                                            :
                                            <div className="d-flex justify-content-center">No course found for this name</div>
