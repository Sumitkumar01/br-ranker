...
const CourseArea = () => {
    const seletedPopularCourses = localStorage.getItem("selectedPopularCourse");
    ...
    console.log(seletedPopularCourses);
    ...
    const filteredCourses = courses_data.filter(course => {
        ...
        // const matchClass = selectedClass === "All" || course.categoryClass === selectedClass;
        const popularCourses= course.title===seletedPopularCourses;
        const matchesSearchTerm = course.classCodeAsOfBoard.toLowerCase().includes(searchTerm.toLowerCase());
        // return matchesBoard && matchClass && matchesSearchTerm;
        return popularCourses && matchesSearchTerm
    });
            ...
            <section className="course__area pt-120 pb-120">
                <div className="container">
                    ...
                    <select onChange={handleClassChange} value={selectedClass} className="">
                      ...
                      {course_class_data.map((item, index) => (
                                                                    ...
                                                                    <div className="course__content">
                                                                        ...
                                                                        <h3 className="course__title">
                                                                            <Link href={`${item.board}/${item.category}/${item.categoryClass}/${item.title}`}>
                                                                                {formattedCourseTitle}{" "}({item.classCodeAsOfBoard})
                                                                            </Link>
                                                                        </h3>
